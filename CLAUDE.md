...
Seven signal-first prospect-discovery agents for Nightingale's GTM motion, plus four Windows PowerShell scripts that register them with Windows Task Scheduler and capture the credentials the intro-finder + daily-brief Layer-B stages need. The repo is **Windows-only** as of 2026-05 — `.sh` parity was dropped to reduce maintenance surface.

The chain has five stages (daily-brief Mon-Fri 6am; sweeps + buying-group chained Mon 7am; intro-finder Sun-Fri 7am; gmail-resurfacer Mon-Fri 7am):
